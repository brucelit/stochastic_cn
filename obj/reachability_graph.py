...
from util.cn_importer import import_weighted_cnet_from_xml
from weighted_causal_net import WeightedCausalNet, State, Binding, Semantics, Obligation
...
class ReachabilityGraph:
    ...
    def __init__(self, weighted_causal_net: WeightedCausalNet):
        """
        Initialize with a causal net.

        Args:
            causal_net: WeightedCausalNet object representing the process model
        """
