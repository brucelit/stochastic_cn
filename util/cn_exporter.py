...
from obj.causal_net import CausalNet, print_cnet_info
...
def load_cnet_from_xml(filename: str) -> CausalNet:
    """
...
def example_causal_net():
    ...
    cnet = CausalNet("ARTIFICIAL_START", "ARTIFICIAL_END")
