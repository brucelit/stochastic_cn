...
def export_stochastic_language(import_path, export_path):
    ...
    with open(export_path, "w") as file:
        ...
        for key, val in variants.items():
            sum += Fraction(val.numerator,val.denominator)
            file.write("\n# trace " + str(i))
            file.write("\n# weight")
...
if __name__ == '__main__':
    export_stochastic_language("../data/road/Road_Traffic_Fine_Management_Process.xes", "../data/road/road.slang")

    # get_variant("../data/travel/PermitLog.xes", "../data/travel/permit_variants.xes")
